...
def maximo_rectangulo(M):
    ...
    return (finalArriba, finalIzq, finalDer - finalIzq + 1, finalAbajo - finalArriba + 1)

    # print("(Top, Left) (", finalArriba, finalIzq, ")")
    # print("(Bottom, Right) (", finalAbajo, finalDer, ")")
    # print("Max sum is:", sumaMaxima)
